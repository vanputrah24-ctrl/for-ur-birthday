...
//     })
//     .add(() => {
//       document.querySelector('.special-letter').classList.add('show');
//     });
...
const LIGHTS_OUT = () =>
  timeline()
    ...
    .add(() => {
      document.querySelector('.envelope-wrapper').classList.add('show');
    });
...
// document.querySelector('.special-letter').classList.remove('show');
